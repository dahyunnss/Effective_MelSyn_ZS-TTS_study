...
#         self.normalized_shape = (in_channel,)
#         self.norm = nn.LayerNorm(self.normalized_shape, elementwise_affine=False)
...
#             # style_code가 None이면, 일반 LayerNorm처럼 처리
#             # (PyTorch의 F.layer_norm 사용)
#             return self.norm(input)
#         # style_code가 있으면 (B, style_dim) -> (B, 2*in_channel)
#         style = self.style(style_code)  # [B, 2*N]
#         style = style.unsqueeze(1)      # [B, 1, 2*N]
#         gamma, beta = style.chunk(2, dim=-1)
