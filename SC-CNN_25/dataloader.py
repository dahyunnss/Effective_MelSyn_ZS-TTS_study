...
def prepare_dataloader(data_path, filename, batch_size, shuffle=True, num_workers=8, meta_learning=False, seed=0):
...
class TextMelDataset(Dataset):
    def __init__(self, data_path, filename="train.txt",): #filename
        self.data_path = data_path #/userHome/userhome2/dahyun/SC-CNN/preprocessed_data/LibriTTS
    ...
    def __getitem__(self, idx):
        basename = self.basename[idx] #8176
        sid = self.sid_dict[self.sid[idx]] #speaker_id
    ...
    def reprocess(self, batch, cut_list):
        ...
        out = {"id": ids,
               "sid": np.array(sids),
               "text": texts,
               "mel_target_lo": mel_targets,
               "mel_target_hi": mel_targets,
               "D": Ds,
               "log_D": log_Ds,
               "f0": f0s,
               "energy": energies,
