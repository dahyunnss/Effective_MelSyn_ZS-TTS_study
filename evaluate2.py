...
def evaluate_lo(args, model_lo, step):    
    ...
    for i, batch in enumerate(data_loader):
        ...
        with torch.no_grad():
            mel_output_lo, _, _, log_duration_output, f0_output, energy_output, src_mask, mel_mask, _ = \
                model_lo(text, src_len, mel_target_lo, mel_len, D, f0, energy, max_src_len, max_mel_len)
